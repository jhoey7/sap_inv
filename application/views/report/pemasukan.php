<div class="panel panel-default">
	...
	<div class="panel-body">
	  <form class="form-inline" method="post" action="<?php echo site_url('report/pemasukan'); ?>" onSubmit="view_report('frm-laporan'); return false;" id="frm-laporan" name="frm-laporan" autocomplete="off">
